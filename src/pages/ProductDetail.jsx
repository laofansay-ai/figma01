...
import { ArrowLeft, Heart, Share, Star, Plus, Minus, ShoppingBag } from 'lucide-react'
...
const ProductDetail = () => {
  ...
  const product = {
    ...
    rating: 4.8,
    reviews: 124,
    description: 'This modern wooden chair combines comfort with style. Crafted from premium oak wood with a sleek design that fits perfectly in any contemporary living space. The ergonomic design ensures maximum comfort for extended sitting.',
    images: [
    ...
    colors: [
      ...
      { name: 'white', color: '#FFFFFF', available: false }
    ],
    sizes: [
  ...
  const reviews = [
    {
      ...
      user: 'Sarah M.',
      rating: 5,
      comment: 'Absolutely love this chair! Great quality and very comfortable.',
      date: '2024-01-15'
    },
    {
      id: 2,
    ...
    <div className="pb-20 bg-white min-h-screen">
              ...
              <button
                ...
                className={`w-10 h-10 rounded-full border-2 ${
                  selectedColor === color.name 
                    ...
                    : 'border-gray-300'
                } ${!color.available ? 'opacity-50 cursor-not-allowed' : ''} transition-all`}
          ...
          <div className="flex space-x-3">
            {product.sizes.map((size) => (
              <button
                ...
                } ${!size.available ? 'opacity-50 cursor-not-allowed' : ''} transition-colors`}
              >
      ...
      <section className="px-4 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="#" className="text-yellow-500 font-medium">See all</Link>
        </div>
